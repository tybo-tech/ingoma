...
export const SEND_EMAIL_ACTIVATE_ACCOUNT = 'https://zoweh.co.za/api/api/email/email-welcome-activate-account.php';
export const SEND_EMAIL_GENERAL_TEXT = 'https://zoweh.co.za/api/api/email/general-email.php';
export const SEND_EMAIL_BILLING = 'https://zoweh.co.za/api/api/email/email-billing.php';
